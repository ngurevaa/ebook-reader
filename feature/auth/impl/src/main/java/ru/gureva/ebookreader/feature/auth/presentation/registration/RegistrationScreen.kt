...
fun RegistrationScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            RegistrationScreenContent(state, dispatch)
        }
    }
    ...
    viewModel.collectSideEffect {
        when (it) {
            ...
            is RegistrationSideEffect.ShowSnackbarWithRetryButton -> {
                coroutineScope.launch {
                    ...
                    if (result == SnackbarResult.ActionPerformed) {
                        dispatch(RegistrationEvent.SignUp)
                    }
                }
            }
...
internal fun RegistrationScreenContent(
    ...
    dispatch: (RegistrationEvent) -> Unit
) {
    Column(
        modifier = Modifier
